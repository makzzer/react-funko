...
const Nav = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gray-900 shadow-md w-full fixed top-0 left-0 md:py-4 py-2 md:pb-0 ">
        ...
        <div className="md:py-1 mx-auto ps-6 md:flex items-center container justify-between  bg-gray-900  md:px-10 px-2 ">
          ...
          <ul
            className={`md:flex md:items-center md:pb-0  absolute md:static pb-1 bg-gray-900 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
          ...
          >
            {navlinks.map((navlink) => {
              return (
                <>
                  <li key={navlink.name} className="bg-gray-900 text-xl md:my-0 my-7">
