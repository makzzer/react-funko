...
const UnderConstruction = ({ mensaje }) => {
  return (
    <>
      <div className="mx-5 flex md:flex-row flex-col justify-center gap-6 items-center md:mx-0 mx-2 container font-mono font-bold bg-gray-900 text-5xl mt-20 pb-10 pt-12">
